...
# Consolidate metadata into a dictionary
metadata = {
    "token_index": token_index,
    "max_encoder_seq_length": int(max_encoder_seq_length),
    "max_decoder_seq_length": int(max_decoder_seq_length),
    "characters": characters
}

# Save to a JSON file
with open('combine_metadata.json', 'w', encoding='utf-8') as f:
    json.dump(metadata, f, ensure_ascii=False, indent=4)

print("Metadata saved as combine_metadata.json")
